...
import 'package:nendoroid_db/app/theme/app_font.dart';
import 'package:nendoroid_db/feature/_common/provider/hive_provider.dart';

class TermsAgreeBottomSheet extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<TermsAgreeBottomSheet> createState() => _TermsAgreeBottomSheetState();
}

class _TermsAgreeBottomSheetState extends ConsumerState<TermsAgreeBottomSheet> {
  bool _agree = false;
