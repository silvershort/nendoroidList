...
import 'package:nendoroid_db/networks/dio/github_dio.dart';
...
abstract class GithubRepository {
  ...
  // 넨돌 데이터 가져오기
  @GET("https://raw.githubusercontent.com/KhoraLee/NendoroidDB/main/NendoroidDoll/{folderName}/{fileName}")
  ...
  // 넨돌 데이터 리스트 받아오기
  @GET("https://api.github.com/repos/KhoraLee/NendoroidDB/contents/NendoroidDoll/{folderName}")
